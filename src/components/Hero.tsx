...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen pt-20 flex items-center overflow-hidden">
      ...
      {/* Floating circles */}
      <div className="absolute top-1/4 left-1/4 w-8 h-8 rounded-full bg-primary/20 animate-float" style={{ animationDelay: "0s" }}></div>
      <div className="absolute top-1/3 right-1/3 w-12 h-12 rounded-full bg-accent/30 animate-float" style={{ animationDelay: "1.5s" }}></div>
      <div className="absolute bottom-1/4 right-1/4 w-6 h-6 rounded-full bg-secondary/40 animate-float" style={{ animationDelay: "0.8s" }}></div>
      
      <div className="container mx-auto px-6 py-12 md:py-24 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 space-y-6 animate-fade-in">
          <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight">
            Transforme seu <span className="text-primary">bem-estar</span> através do toque terapêutico
          </h1>
          <p className="text-lg text-foreground/80 max-w-xl">
            Descubra a arte da massagem terapêutica personalizada, projetada para aliviar o estresse, reduzir dores e promover um profundo relaxamento para corpo e mente.
          </p>
